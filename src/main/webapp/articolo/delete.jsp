	...
	<main role="main" class="container">
		...
		<div class='card'>
		    <div class='card-header'>
		        Riepilogo dell'articolo da cancellare
		    </div>
		    <% Articolo articoloInPagina = (Articolo)request.getAttribute("articoloDaCancellare"); %>
		    <div class='card-body'>
		    	<dl class="row">
		    ...
		    <div class='card-footer'>
		        ...
		        <a href="ExecuteDeleteArticoloServlet?idArticolo=<%= articoloInPagina.getId() %>" class='btn btn-outline-danger' style='width:100px; float:right;'>
